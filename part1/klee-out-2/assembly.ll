...
entry:
  ...
  %1 = call i32 (...)* @klee_make_symbolic(i32* %c, i32 4, i8* getelementptr inbounds ([2 x i8]* @.str, i32 0, i32 0)) nounwind, !dbg !8 ; <i32> [#uses=0]
...
bb2:                                              ; preds = %bb
  %9 = load i32* %a, align 4, !dbg !13            ; <i32> [#uses=1]
  %10 = load i32* %b, align 4, !dbg !13           ; <i32> [#uses=1]
  %11 = add nsw i32 %9, %10, !dbg !13             ; <i32> [#uses=1]
